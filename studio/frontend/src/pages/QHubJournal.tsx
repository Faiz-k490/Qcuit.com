...
const fallbackPosts: BlogPost[] = [
  {
    ...
    category: 'Tutorial',
    topics: ['noise', 'circuits', 'beginners'],
    reading_time: 1,
...
function CallForPapers() {
  return (
    <section className="mt-14 bg-isabelline border border-vegas-gold/20 rounded-sm p-12">
      <h2 className="font-display text-3xl text-deep-jungle mb-4 text-center">Call for Articles</h2>
      <p className="text-center text-deep-jungle/70 leading-relaxed max-w-2xl mx-auto mb-10">
        The Q-Hub Journal welcomes original articles in quantum computing education, algorithms, systems,
        and pedagogy. Submissions are editorially reviewed for clarity, rigor, and practical relevance.
      </p>
    ...
    <div className="min-h-screen bg-deep-jungle text-deep-jungle px-6 py-12">
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-12 border-b border-vegas-gold/20 pb-8">
          <p className="text-[11px] font-display tracking-[0.28em] uppercase text-vegas-gold/70 mb-3">Qcuit Journal</p>
          <h1 className="font-display text-5xl text-isabelline leading-tight">The Q-Hub</h1>
          <p className="mt-4 text-isabelline/70 max-w-3xl leading-relaxed">
            A curated publication for quantum computing scholarship, educational methods, and practical systems research.
          </p>
        </header>

        {loading ? (
          <div className="bg-isabelline border border-vegas-gold/20 rounded-sm p-10 text-deep-jungle/70">Loading journal archive...</div>
        ) : activePost ? (
