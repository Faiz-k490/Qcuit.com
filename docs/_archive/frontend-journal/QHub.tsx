/**
 * Qcuit Research Community Page
 * 
 * Discord/Forum-style community space for quantum ML library contributors
      ...
      <aside className="w-64 bg-black/40 border-r border-white/[0.05] flex flex-col">
        ...
        <div className="p-4 border-b border-white/[0.05]">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-bold text-white">Qcuit Research</h1>
              <p className="text-xs text-zinc-500">Library Community</p>
            </div>
          </div>
        </div>
