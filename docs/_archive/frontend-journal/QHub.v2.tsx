/**
 * Qcuit Research Community Page v2.0
 * 
 * Progressive Old Money aesthetic community space for the Qcuit library
...
interface Message {
  id: string;
  user: string;
  badge: 'contributor' | 'researcher' | 'mentor' | 'admin';
  content: string;
  timestamp: string;
...
const badgeColors: Record<string, string> = {
  contributor: 'bg-vegas-gold/10 text-vegas-gold border-vegas-gold/30',
...
const channels: Channel[] = [
  { id: 'general', name: 'general', icon: '💬', description: 'General Qcuit library discussion' },
  { id: 'hep-qml', name: 'hep-qml', icon: '📚', unread: 3, description: 'HEP, jet graphs, Lorentz symmetry, and QML workflows' },
  { id: 'quantum-layers', name: 'quantum-layers', icon: '🔬', description: 'Quantum layers, embeddings, and backend integration' },
  { id: 'benchmarks', name: 'benchmarks', icon: '✨', description: 'Share benchmark results and reproducibility notes' },
  { id: 'issues', name: 'issues', icon: '⚙️', description: 'Report package issues and help debug' },
  { id: 'papers', name: 'papers', icon: '📖', description: 'Share papers, datasets, and implementation notes' },
];
...
const sampleMessages: Message[] = [
  {
    ...
    user: 'Alice Chen',
    badge: 'contributor',
    content: 'Can someone sanity-check this JetDataset split? I want the quark/gluon toy benchmark to stay deterministic across machines.',
    timestamp: '2 min ago',
  ...
  },
  {
    ...
    user: 'Dr. Marcus Webb',
    badge: 'researcher',
    content: 'Good target. Keep the split seeded, report accuracy plus AUC, and include the parameter count so a lab can compare LorentzNet and LieEQGNN runs cleanly.',
    timestamp: '1 min ago',
  ...
  },
  {
    ...
    user: 'Jordan Taylor',
    badge: 'mentor',
    content: 'Also worth exporting the BenchmarkReport JSON. That gives you a stable artifact for HPC smoke tests and notebook comparisons.',
    timestamp: 'just now',
  },
];
...
export function QHub() {
  ...
  const [activeChannel, setActiveChannel] = useState('hep-qml');
      ...
      <aside className="w-64 bg-forest-light/30 border-r border-vegas-gold/10 flex flex-col">
        ...
        <div className="p-5 border-b border-vegas-gold/10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display font-bold text-isabelline text-lg">Qcuit Research</h1>
              <p className="text-xs text-isabelline/50 font-body">Library Community</p>
            </div>
          </div>
        </div>
      ...
      <aside className="w-60 bg-forest-light/30 border-l border-vegas-gold/10 p-5 hidden lg:block">
        ...
        <div className="space-y-3">
          {[
            ...
            { name: 'Alice Chen', badge: 'contributor', status: 'online' },
          ].map((member, i) => (
